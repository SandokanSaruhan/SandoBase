...
class ThirdViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //  Info
        print("Create Collection Views Page")
        print("ThirdViewController Page")
...
extension ThirdViewController: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return 15 // How many cells to display
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        title.font = UIFont.systemFont(ofSize: 20, weight: UIFont.Weight.thin)
        ...
        case 13:
            ...
            title.text = "Tab Bar Menu Page"
            
        case 14:
            
            title.text = "Left Sided Menu Page"
